	...
	return (
		<section className='section min-h-[700px]' id='contact'>
			<div className='container lg:grid lg:grid-cols-2 lg:items-stretch'>
				...
				<div className='mb-12 grid justify-between bg-cover size-[280px] md:size-[450px] xl:size-[500px] px-5'  style={{backgroundImage: `url("/img/poker_cats.jpg")`}}>
					...
					<div className='xl:pl-10 2xl:pl-20'>
						...
						<div className='mb-4'>
							...
							<input
								...
								autoComplete='email'
								required
								placeholder='poker-szop@szop.pl'
								className='text-field'
							/>
						</div>
						<div className='mb-4'>
